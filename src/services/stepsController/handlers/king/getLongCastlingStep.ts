...
export default function ({
  ...
  const thirdKingSiblingCellId = handleMove(secondKingSiblingCellId)!;
  const thirdKingSiblingCell = findById(thirdKingSiblingCellId, cells) as Cell;
  if (thirdKingSiblingCell.figure) return;
